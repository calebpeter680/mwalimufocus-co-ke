...
def send_attachments_for_paid_orders():
    ...
    for order in paid_orders:
        ...
        if brand:
            ...
            print("Brand information missing. Cannot send complete message.")
        ...
        if to_email and validate_email(to_email):
            email = EmailMessage(subject, plain_message, from_email, [to_email])
            ...
            if not to_email:
                print(f"Order {order.display_order_number} does not have a valid user email.")
            else:
